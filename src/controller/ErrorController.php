...
class ErrorController extends Controller
{
    ...
    public function __construct(array $mydata = array(), $errorcode = '404')
    {
        $mydata['pagename'] = 'error';
        $mydata['pagetitle'] = "Error $errorcode";
    ...
    private function getErrorName($errorcode)
    {
